...
from src.coatnet_models import CoAtNetSideViTClassifier_MLP_CNNVIT, CoAtNetSideViTClassifier_Advanced
from src.resnet_models import ResNetSideViTClassifier_FC_CNNVIT, ResNetSideViTClassifier_MLP_CNNVIT
...
def main(cfg):
    ...
    match cfg.network.model:
        case "coatnet_1":
            EnhancedSideViTClassifier = CoAtNetSideViTClassifier_MLP_CNNVIT
        case "coatnet_2":
