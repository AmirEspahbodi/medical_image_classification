...
from src.coatnet_models import CoAtNetSideViTClassifier_1, CoAtNetSideViTClassifier_2
from src.resnet_models import ResNetSideViTClassifier_1, ResNetSideViTClassifier_2
